...
public class PlotThirdOctaveCopy extends View {
    ...
    public PlotThirdOctaveCopy(Context context) {
        this(context, null, 0);
    }

    public PlotThirdOctaveCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlotThirdOctaveCopy(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        paintLabelsMaxRectStroke.setColor(getResources().getColor(R.color.plot_grey_dark));
        ...
        String display_color = preferences.getString("display_color", "1");
